...
/**
 * This will be implemented on a co-processor, and won't actually be called
 * in the robot code. Instead, we will run this code on a co-processor and 
 * have the co-processor send the results using NetworkTables.
 * 
 * DemonVision class.
 *
 ...
 * @author GRIP
*/
public class DemonVision implements VisionPipeline {
